...
twice, by two different vendors' models writing 1,483 and 895 lines that both
landed on root `4b90feef…`, the second in 12 minutes for $3.40.
...
That is the whole loop, and it is the one this repository runs on itself.
...
`spec/claim-format.md` defines the recipe; `spec/verification.md` defines what
each verdict means. `ret --help` lists the verbs.
