...
dissent identified as finding 12. **Its proof is pending**: a revision
orphans the previous crosscheck by design, and a fresh cross-vendor blind
rebuild against this suite is the open next step
